...
typedef enum
{
    ...
    AP_S_PRESS6S = 0x14,
    REBOOT_REASON_LABEL1 = 0x20,
    AP_S_ABNORMAL = REBOOT_REASON_LABEL1,
    AP_S_TSENSOR0 = 0x21,
    AP_S_TSENSOR1 = 0x22,
    AP_S_AWDT = 0x23,
    CHARGER_S_WDT = 0x24,
    G3D_S_G3DTSENSOR = 0x25,
    LPM3_S_LPMCURST = 0x26,
    CP_S_CPTSENSOR = 0x27,
    IOM3_S_IOMCURST = 0x28,
    ASP_S_ASPWD = 0x29,
    CP_S_CPWD = 0x2a,
    IVP_S_IVPWD = 0x2b,
    ISP_S_ISPWD = 0x2c,
    AP_S_DDR_UCE_WD = 0x2d,
    AP_S_DDR_FATAL_INTER = 0X2e,
    OCBC_S_WD = 0x2f,
    REBOOT_REASON_LABEL2 = 0x40,
    AP_S_PANIC = REBOOT_REASON_LABEL2,
    AP_S_NOC = 0x41,
    AP_S_RESUME_SLOWY = 0x42,
    AP_S_DDRC_SEC = 0x43,
    AP_S_F2FS = 0x44,
    AP_S_COMBINATIONKEY = 0x45,
    AP_S_BL31_PANIC = 0x46,
    AP_S_MAILBOX = 0x47,
    AP_S_HHEE_PANIC = 0x48,
    REBOOT_REASON_LABEL3 = 0x50,
    ...
    LPM3_S_EXCEPTION = 0x62,
    SOCHIFI_S_EXCEPTION= 0x63,
    HIFI_S_RESETFAIL = 0x64,
    ISP_S_EXCEPTION = 0x65,
    IVP_S_EXCEPTION = 0x66,
    IOM3_S_EXCEPTION = 0x67,
    TEE_S_EXCEPTION = 0x68,
    MMC_S_EXCEPTION = 0x69,
    CODECHIFI_S_EXCEPTION = 0x6a,
    IOM3_S_USER_EXCEPTION = 0x6b,
    HISEE_S_EXCEPTION = 0x6c,
    REBOOT_REASON_LABEL4 = 0x70,
    RESERVED4 = REBOOT_REASON_LABEL4,
    BR_KEY_VOLUMN_DOWN_UP_UPDATE_USB = 0x71,
    BR_KEY_VOLUMN_DOWN_UP_UPDATE_SD_FORCE = 0x72,
    BR_KEY_VOLUMN_UP = 0x73,
    BR_KEY_POWERON_PRESS_1S = 0x74,
    BR_KEY_POWERON_PRESS_10S = 0x75,
    BR_CHECKPOINT_RECOVERY = 0x76,
    BR_CHECKPOINT_ERECOVERY = 0x77,
    BR_CHECKPOINT_SDUPDATE = 0x78,
    BR_CHECKPOINT_USBUPDATE = 0x79,
    BR_CHECKPOINT_RESETFACTORY = 0x7a,
    BR_CHECKPOINT_HOTAUPDATE = 0x7b,
    BR_POWERON_BY_USB_NO_BAT = 0x7c,
    BR_NOGUI = 0x7d,
    BR_FACTORY_VERSION = 0x7e,
    BR_RESET_HAPPEN = 0x7f,
    BR_POWEROFF_ALARM = 0x80,
    BR_POWEROFF_CHARGE = 0x81,
    BR_POWERON_BY_SMPL = 0x82,
    BR_CHECKPOINT_UPDATEDATAIMG = 0x83,
    BR_REBOOT_CPU_BUCK = 0x84,
    BR_L2_CACHE_FAIL = 0x85,
    REBOOT_REASON_LABEL5 = 0x90,
    AP_S_PMU = REBOOT_REASON_LABEL5,
    AP_S_SMPL = 0x91,
    AP_S_SCHARGER = 0x92,
    REBOOT_REASON_LABEL6 = 0xa0,
    ...
    REBOOT_REASON_LABEL7 = 0xb0,
    FASTBOOT_S_EMMCINIT_FAIL = REBOOT_REASON_LABEL7,
    FASTBOOT_S_PANIC = 0xb1,
    FASTBOOT_S_WATCHDOG = 0xb2,
    FASTBOOT_S_OCV_VOL_ERR = 0xb3,
    FASTBOOT_S_BAT_TEMP_ERR = 0xb4,
    FASTBOOT_S_MISC_ERR = 0xb5,
    FASTBOOT_S_LOAD_DTIMG_ERR = 0xb6,
    FASTBOOT_S_LOAD_OTHER_IMGS_ERR = 0xb7,
    FASTBOOT_S_KERNEL_IMG_ERR = 0xb8,
    FASTBOOT_S_LOADLPMCU_FAIL = 0xb9,
    FASTBOOT_S_IMG_VERIFY_FAIL = 0xba,
    FASTBOOT_S_SOC_TEMP_ERR = 0xbb,
 FASTBOOT_S_FLASH_PROTECTION_PANIC = 0xbc,
    REBOOT_REASON_LABEL8 = 0xd0,
    REBOOT_REASON_LABEL9 = 0xd0,
    BFM_S_BOOT_NATIVE_BOOT_FAIL = REBOOT_REASON_LABEL9,
    BFM_S_BOOT_TIMEOUT,
    BFM_S_BOOT_FRAMEWORK_BOOT_FAIL,
    BFM_S_BOOT_NATIVE_DATA_FAIL,
    REBOOT_REASON_LABEL10 = 0xe0,
} EXCH_SOURCE;
enum MODID_LIST {
