 ...
 ******************************************************************************
  ...
  History           :
     ...
     4.lining 00141619         2008-10-29  MM
     5.sunbing 49683           2008-10-30  SMIDSM
     6.leili 00132387          2008-12-03  APPMM
     7.hanlufeng 41410         2009-03-11  BA8D01164 APP
     8.hanlufeng 41410         2009-05-12  BJ9D00722 APP
     9.xiaojun 58160           2009-05-19  BJ9D00828  AppMmInterface.h
                               OmCommon.h
...
/* APP_MM_MSG_ID_UINT324:

-----------------------------------------------------------
                                        
-----------------------------------------------------------
| BYTE14 + 0000 |  BYTE2    |   BYTE3    |    BYTE4   |
-----------------------------------------------------------
0000|   |  | 0-255
-----------------------------------------------------------
0001L2 LOG        |           |            |
...
/*****************************************************************************
    ...
    :
    ucSplitPgCode: [0,98]
    ucPsDrxLen:(0,6,7,8,9),0:UEDRX Cycle Len
    ucSplitOnCcch:0  1
    ucNonDrxTimer:[0,7]
*****************************************************************************/
typedef struct
...
/*V7R2-DT ,l00195322,2014/4/23,CNF IND, begin*/
typedef struct
{
    VOS_MSG_HEADER                                  /*_H2ASN_Skip*/
    VOS_UINT32                            ulMsgId;  /*_H2ASN_Skip*/
...
/*V7R2-DT ,l00195322,2014/4/23,CNF IND, end*/
...
typedef struct
{
    ...
    LNAS_APP_UE_CAP_INFO_STRU               stLnasUeCapInfo;    /* LNASUE */
    IMSA_APP_UE_CAP_INFO_STRU               stImsaUeCapInfo;    /* IMSAHIDSUE */
}MM_APP_UE_CAP_INFO_CNF_STRU;
