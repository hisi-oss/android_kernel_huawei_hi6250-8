...
/*,OSAWIN32,PCminiDOPRA,
  PS_SEND_MSG,WIN32VXWORKS,WIN32,
  Ps_SendMsg,PC STUB.OSAWIN32,*/
    #if(VOS_OS_VER == VOS_WIN32 )
...
#else   /*WIN32 DOPRA 1.6.1DYNAMIC_MEM_PTBUGBLOCK_MEM_PT-h42180*/
/*lint -emacro({586}, PS_MEM_ALLOC)*/
#define PS_MEM_ALLOC(ulPid , ulSize) \
