...
enum APP_RRC_MSG_ID_ENUM
{
    ...
    ID_LRRC_DT_MEAS_INFO_IND     = (0x988),/* Indid0x988id_lrrc_lphy_conn_meas_ind */
    ID_LRRC_DT_SYNC_INFO_IND     = (0x904),/* Indid0x904id_lrrc_lphy_sync_info_ind */
    ID_LRRC_DT_OUT_OF_SYNC_INFO_IND = (0x90f),/* Indid0x90fid_lrrc_lphy_out_of_sync_info_ind */
    /* end:add for  */
...
{
    LRRC_CA_CC_NUM_2,                             /* CA CC2CC */
    LRRC_CA_CC_NUM_3,                             /* CA CC3CC */
    LRRC_CA_CC_NUM_4,                             /* CA CC4CC */
    LRRC_CA_CC_NUM_BUTT
};
...
typedef struct
{
    /* ulFGI01To32: APPbit: short DRX:FGI4, C-DRX:FGI5, L-W,PSHO:FGI8,
       L-G,PSHO:FGI9, CSFB w/measurements(REL9):FGI22, TTI Bundling:FGI28, SPS:FGI29 */
    VOS_UINT32                          ulFGI01To32;                            /* fgi bitFGI1FGI32 */
    VOS_UINT32                          ulFGI33To64;                            /* fgi bitFGI33FGI64 */
    VOS_UINT32                          ulFGI101To132;                          /* fgi bitFGI101FGI132 */
    VOS_UINT32                          ulFGIReserved;                          /* fgi bit32bit */
    ...
    VOS_UINT32                          aulBandInd[LRRC_APP_MAX_BAND_IND_ARRAY_NUM]; /* aulBandInd,BIT1:0
                                                                                ulBandInd[0]BITBAND1,; */
    VOS_UINT32                          aul256Qam[LRRC_APP_MAX_BAND_IND_ARRAY_NUM]; /* aul256Qam,BIT1:0
                                                                                aul256Qam[0]BIT; */
...
typedef struct
{
    ...
    APP_MSG_HEADER
    VOS_UINT32                          ulOpId;
    VOS_UINT16                          usSwt;              /* 0:  1: RSSIIND  2: RSSI */
    VOS_UINT16                          usPeriod;
...
typedef struct
{
    ...
    VOS_UINT32                          ulMsgId;            /*_H2ASN_Skip*/
    APP_MSG_HEADER
    VOS_UINT32                          ulOpId;             /* MSPIDCmdIDProb */
    APP_RESULT_ENUM_UINT32              enResult;
...
typedef struct
{
    ...
    VOS_INT16                                       sServqual;           /*SQ*/
    VOS_INT16                                       sThreshServingLowP;  /*  */
    VOS_INT16                                       sThreshServingLowQ;  /* SR9 */
...
typedef struct
{
    ...
    LRRC_GRR_BSIC_INFO_STRU   stBsic;         /* BSICBSIC */
    VOS_UINT32                ulMeasTimeInterval;    /*  */
}LRRC_CONN_MEAS_FILTER_GERA_INFO_STRU;
