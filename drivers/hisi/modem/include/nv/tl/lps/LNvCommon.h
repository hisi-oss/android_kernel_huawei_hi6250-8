...
{
    EN_NV_ID_BEGIN                                  = 0,
    /*LNAS NV:Boston NVIMSA[50501,53000][50501,52000]MBB
      MBBLNAS[31000,32500],nvid
      4C2C*/
    EN_NV_ID_LNAS_NEW_NV_INTERVAL_BEGIN             = 0x7918,/* LNAS NEW ALLOCATE NV INTERVAL BEGIN*/
    EN_NV_ID_IMS_BEGIN                              = 0x7919,/* IMS BEGIN */
    EN_NV_ID_IMS_CONTROL                            = 0x791A,/* IMS NV, jiaguocai for IMS support flag, 2016-10-11*/
    EN_NV_ID_IMS_SIP_TIMER                          = 0x791B,/* SIP, Added by s00193151 for KT, 2016-12-05 */
    ...
    EN_NV_ID_NAS_DETACH_ATTEMPT_CNT_CTRL_CONFIG     = 0x7985,/* detachmmc*/
    EN_NV_ID_NAS_STORE_MMC_DETACH_CTRL_CONFIG       = 0x7986,/* ATTACHMMC DETACH */
    ...
    EN_NV_ID_LNAS_TMO_IMSI_HPLMN_LIST_CONFIG        = 0x798B,/* TMOIMSI HPLMN */

    EN_NV_ID_LNAS_MT_DETACH_WITH_OPTIMZIE_CONFIG    = 0x798f,
    EN_NV_ID_NETWORK_FEATURE_VOPS_OPTIMIZE_CTRL     = 0x7999, /* NVZAINeps network feature support,VOLTEIMS */
    ...
    EN_NV_ID_EMC_PDN_REJ_CONFIG                     = 0x7BD8,/* PDNNV */
    EN_NV_ID_IMSA_REREG_CTRL                        = 0x7BD9,
    EN_NV_ID_VISP_WAKEUP_COMPENS_TIMER_CTRL         = 0x7BDA,
    EN_NV_ID_JAPAN_FEATURE_CONFIG                   = 0x7BDB,
    EN_NV_ID_REG_STRATEGY_CONFIG                    = 0x7BDC,/* , Added by s00193151 for ChinaTelecom_Volte, 2017-01-20 */
    EN_NV_ID_CTCC_CUSTOM_CONFIG                     = 0x7BDD,/* , Added by s00193151 for ChinaTelecom_Volte, 2017-01-20 */
    EN_NV_ID_NORMAL_PDN_REJ_CONFIG                  = 0x7BDE,/* PDNESM, Added by s00193151 for ChinaTelecom_Volte, 2017-01-20 */
    ...
    EN_NV_ID_REG_FAIL_PDN_RETRY_CONFIG              = 0x7BE3,/* PDNNV */
    EN_NV_ID_EMC_TCALL_CTRL                         = 0x7BE5,/* TCALLNV */
    /* zhangdongfeng, 00353461, check PingPong Exist or not in L2W handover, begin in 2017-03-30 */
    EN_NV_ID_IMSA_PINGPONG_CONFIG                   = 0x7BE6, /* LTE/WiFiNV */
    ...
    EN_NV_ID_LNAS_ESM_IPV4_MTU_CTRL_CONFIG          = 0XCBEB,/*IPV4 MTUnv */
    /* Added by wangchen 0020918 2016-12-14 for KDDI,begin */
    EN_NV_ID_LNAS_ESM_CHANGE_TO_IMSAPN_CONFIG       = 0xCBEC, /* ATTACHIMSAPN */
    ...
    EN_NV_ID_RA_FAIL_REPORT_INFO                    = 0xD290,/* CHR NV  k00279574 */
    EN_NV_ID_TEST_PLMN_SET                          = 0xD291,/* PLMNbegin */
    ...
    EN_NV_ID_POWER_ON_LOG_SWITCH                    = 0xD33b,/* Added by x00300294 for log */
    ...
    EN_NV_ID_UE_CAP_V1180_BAND_COMB_PARAM1          = 0xD5a0,/* DSPNVPSNV */
